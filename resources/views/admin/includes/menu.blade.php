        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('add-size') }}">Add Size</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('add-color') }}">Add Size</a></li>
                        <li><a href="{{ route('manage-color') }}">Manage Size</a></li>
                    </ul>
                </li>
                ...
                <li><a href="{{ route('manage-order') }}" class=" waves-effect"><i class="bx bx-task"></i><span>Order</span></a></li>
