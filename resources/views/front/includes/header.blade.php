    ...
    <div id="top-header">
        <div class="container">
            ...
            <ul class="header-links pull-right">
                ...
                @else
                    <li><a href="{{ route('login-check') }}"><i class="fa fa-user-o"></i> Login</a></li>
                @endif
            </ul>
        </div>
    </div>
                    ...
                    <div class="header-ctn">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="cart-dropdown">
                                <div class="cart-list">
                                    @foreach($cart_array as $key => $v_add_cart)
                                        @php
                                        ...
                                        <div class="product-widget">
                                            ...
                                            <a class="delete" href="{{ route('delete-cart', ['id'=>$v_add_cart['id']]) }}"><i class="fa fa-close"></i></a>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="cart-btns">
                                    ...
                                    @endphp
                                    @if($customer_id != Null)
                                        <a style="width: 100%; background-color: #D10024;" href="{{ route('checkout') }}"><i class="fa fa-arrow-circle-right"></i> Checkout</a>
                                    @else
                                        <a style="width: 100%; background-color: #D10024;" href="{{ route('login-check') }}"><i class="fa fa-arrow-circle-right"></i> Checkout</a>
                                    @endif
                                </div>
                            </div>
                        </div>
